<template>
	<n-form class="mt-4" :label-width="90" :model="formValue" :rules="rules" label-placement="left" ref="form1Ref">
...
const myAccountList = [
	{ label: "NaiveUiAdmin@163.com", value: 1 },
	{ label: "NaiveUiAdmin@qq.com", value: 2 },
];
...
const rules = {
	...
	myAccount: { required: true, type: "number", message: "请选择付款账户", trigger: "change" },
};
